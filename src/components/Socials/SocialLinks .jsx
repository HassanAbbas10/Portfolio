...
const SocialLinks = () => {
	return (
		<div className="flex flex-wrap justify-center sm:justify-start space-x-2 sm:space-x-3 md:space-x-4 lg:space-x-5 text-base sm:text-lg">
			{socialLinks.email && (
				<button className="bg-custom-orange border border-custom-teal rounded-full mb-2 sm:mb-0">
			...
			{socialLinks.linkedin && (
				<button className="bg-blue-400 rounded-full mb-2 sm:mb-0">
					<span className="p-1 sm:p-2">
			...
			{socialLinks.github && (
				<button className="bg-slate-600 rounded-full mb-2 sm:mb-0">
					<span className="p-1 sm:p-2">
			...
			{socialLinks.instagram && (
				<button className="bg-pink-400 rounded-full mb-2 sm:mb-0">
					<span className="p-1 sm:p-2">
