        ...
        <h2 className="text-4xl font-bold uppercase text-custom-teal font-quicksand">
          ...
          <div className="container mx-auto flex px-20 py-24 md:flex-row flex-col items-center">
            <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
              ...
              />
              <p className='title-font sm:text-xl text-xl mb-4 font-medium font-quicksand text-gray-300 my-8'>Currently Working on Projects </p>
              </h1>
              ...
              <a href={CV} download="My CV" target='_blank'>Download CV</a></button>
